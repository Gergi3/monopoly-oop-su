...
namespace CommandHandlerConstants
{
	...
	static const Option SELL_PROPERTY = { 101, "Sell Property (To Player)" };
	...
	static const Option SELL_RAILROAD = { 202, "Sell Railroad (To Player)" };

	static const Option BUY_UTILITY = { 301, "Buy Utility (On Tile)" };
	static const Option SELL_UTILITY = { 302, "Sell Utility (To Player)" };
