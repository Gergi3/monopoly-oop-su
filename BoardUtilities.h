...
namespace BoardUtilities
{
	...
	inline Vector<int> makeRentTable(std::initializer_list<int> rents)
	{
		Vector<int> v;
		for (int r : rents)
			v.push_back(r);
	...
	inline Vector<PropertyData> makeBrownProperties()
	{
	...
	inline Vector<PropertyData> makeLightBlueProperties()
	{
		Vector<PropertyData> props;
	...
	inline Vector<PropertyData> makePinkProperties()
	{
		Vector<PropertyData> props;
	...
	inline Vector<PropertyData> makeOrangeProperties()
	{
		Vector<PropertyData> props;
	...
	inline Vector<PropertyData> makeRedProperties()
	{
		Vector<PropertyData> props;
	...
	inline Vector<PropertyData> makeYellowProperties()
	{
		Vector<PropertyData> props;
	...
	inline  Vector<PropertyData> makeGreenProperties()
	{
		Vector<PropertyData> props;
	...
	inline Vector<PropertyData> makeBlueProperties()
	{
		Vector<PropertyData> props;
